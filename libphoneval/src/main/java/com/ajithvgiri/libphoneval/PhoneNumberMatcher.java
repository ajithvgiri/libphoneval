...
import com.ajithvgiri.libphoneval.PhoneNumberUtil.Leniency;
import com.ajithvgiri.libphoneval.PhoneNumberUtil.MatchType;
import com.ajithvgiri.libphoneval.PhoneNumberUtil.PhoneNumberFormat;
...
import com.ajithvgiri.libphoneval.Phonenumber.PhoneNumber;
import com.ajithvgiri.libphoneval.Phonenumber.PhoneNumber.CountryCodeSource;
...
final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
  ...
  static boolean checkNumberGroupingIsValid(
    ...
    PhoneMetadata alternateFormats = util.getMetadataSource().getAlternateFormatsForCountry(number.getCountryCode());
